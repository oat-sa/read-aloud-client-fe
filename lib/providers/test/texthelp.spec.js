...
import { voices, speeds } from '../../preferences.js';
    ...
    it('toggles clickToSpeak', () =>
        Promise.all([getReadAloudClient('texthelp', { url, speechstreamConfig }), mockTexthelpScript()]).then(
            results => {
                ...
                speechstreamApiMock.speechTools.getClickToSpeakState.mockReturnValueOnce(true).mockReturnValueOnce(false);
    ...
    it('sets preferences', () =>
        Promise.all([getReadAloudClient('texthelp', { url, speechstreamConfig }), mockTexthelpScript()]).then(
            results => {
                ...
                expect(speechstreamApiMock.speechTools.setVoiceSpeed).toHaveBeenCalledWith(20);
                expect(speechstreamApiMock.speechTools.setVoice).toHaveBeenCalledWith('Tom');
                ...
                expect(speechstreamApiMock.speechTools.setVoice).toHaveBeenCalledWith('Ava');
