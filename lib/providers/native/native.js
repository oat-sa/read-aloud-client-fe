    ...
    return Promise.race([
        ...
        play(element) {
            if (element instanceof HTMLElement) {
                const utterance = createUtterance(getTextToRead(element), findClosestLang(element) || config.lang);
                utterance.onstart = () => readStartHandler?.();
                utterance.onend = () => readEndHandler?.();
         ...
         */
        resume() {
            // do not check speechSynthesis.paused, it seems unreliable
