 ...
 */
function restoreLangAttribute() { const langHolderElements = document.querySelectorAll('[data-tts-original-lang]'); for (let langHolderElement of langHolderElements) {
